...
Os tipos primitivos, como inteiros, ponto flutuante, char e boolean, desempenham papéis específicos.
A classe String é essencial para operações com textos.
O casting resolve conflitos de tipos, permitindo conversões explícitas.

Essas habilidades formam a base para o desenvolvimento eficaz de programas em Java,
por isso criamos atividades práticas (não obrigatórias) para você praticar.
Vamos praticar?
...
public class Main {
    ...
    char letra = 'a' ;
    String textoTeste= "teste teste";
        System.out.println(letra + textoTeste);


    double precoProduto = 80.50;
    int quantidade = 5;
    double contaProdutoQuantidade = precoProduto * quantidade;

    String mensagemProdutoQuantidade = "O total ficou ";
    System.out.println(mensagemProdutoQuantidade + contaProdutoQuantidade);

    double valorEmDollares = 20.50;
    double valorEmReais = valorEmDollares * 4.94;
    System.out.println(valorEmReais);


    double precoOriginal = 50.45;
    double percentualDesconto = precoOriginal * 0.9;
